...
<h1>Libros</h1>
		...
		<td>
		<button> <a href="${pageContext.request.contextPath}/libros/findOne?idCliente=${item.idLibro}&opcion=1"> Actualizar </a></button>
		<button> <a href="${pageContext.request.contextPath}/libros/findOne?idCliente=${item.idLibro}&opcion=2"> Eliminar </a></button>
